...
import (
	...
	_interface "app/src/internal/repository/interface"
	"app/src/internal/repository/interface/mocks"
	"context"
	//_interface "app/src/internal/service/interface"
	"reflect"
	"testing"
)
...
func TestInstrumentalistService_Delete(t *testing.T) {
	...
	for _, tt := range tests {
		//new(mocks.IInstrumentalistRepository).On("Delete", context.Background(), tt.args.request).Return(nil)
		prodRepo := new(mocks.IInstrumentalistRepository)
