...
// AddReserveEquipment provides a mock function with given fields: ctx, request
func (_m *IReserveRepository) AddReserveEquipment(ctx context.Context, request *dto.AddReserveEquipmentRequest) error {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for AddReserveEquipment")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *dto.AddReserveEquipmentRequest) error); ok {
		r0 = rf(ctx, request)
	} else {
		r0 = ret.Error(0)
	}
...
// GetByEquipmentsId provides a mock function with given fields: ctx, request
func (_m *IReserveRepository) GetByEquipmentsId(ctx context.Context, request *dto.GetReserveByEquipmentsIdRequest) ([]*model.Reserve, error) {
	ret := _m.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for GetByEquipmentsId")
	}

	var r0 []*model.Reserve
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *dto.GetReserveByEquipmentsIdRequest) ([]*model.Reserve, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *dto.GetReserveByEquipmentsIdRequest) []*model.Reserve); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *dto.GetReserveByEquipmentsIdRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// NewIReserveRepository creates a new instance of IReserveRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
